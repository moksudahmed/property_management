        ...
        <Card className="theme-settings">
          <Card.Body className="pt-4">
            ...
            <div className="d-flex justify-content-between align-items-center mb-3">
              ...
              <GitHubButton href="https://github.com/example.com" data-size="large" data-show-count="true" aria-label="GitHub">Star</GitHubButton>
            </div>
            <Button href="https://example.com" target="_blank" variant="primary" className="mb-3 w-100"><FontAwesomeIcon icon={faDownload} className="me-1" /> Download</Button>
            <p className="fs-7 text-gray-700 text-center">Available in the following technologies:</p>
            <div className="d-flex justify-content-center">
              <Card.Link href="https://example.com" target="_blank">
