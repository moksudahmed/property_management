        ...
        <Card>
          <Card.Body>
            <article>
              ...
              <p className="fs-5 fw-light">This guide will help you get started with Property Management Software</p>

              <p>
                <b>Property Management Software</b> is built on top of <Card.Link href="https://react-bootstrap.github.io/" target="_blank">React Bootstrap</Card.Link> using <a href="https://github.com/facebook/create-react-app/" target="_blank" rel="noopener noreferrer">Create React App</a>.
              </p>
              ...
              <ol className="ps-4 docs-list">
                ...
                <li>
                  <p>After installing yarn, open a terminal and run <code>yarn install</code> in the main <code>Property</code> folder to download all project dependencies.</p>
              ...
              <ol className="ps-4 docs-list">
                ...
                <li>
                  <p>After installing node.js, open a terminal and run <code>npm install</code> in the main <code>properties</code> folder to download all project dependencies. You'll find them in the <code>node_modules</code> folder.</p>
