        ...
        <Card>
          <Card.Body>
            <article>
              ...
              <p className="fs-5 fw-light">Download files for Property Management Software</p>

              <p>Property Management Software is a React.js and Bootstrap 5 powered admin dashboard template featuring components, pages and plugins that you can use to create an awesome and interactive admin interface.</p>
