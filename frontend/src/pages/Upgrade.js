        ...
        <>
            <Row className="mt-lg-5 mt-4 d-flex justify-content-center">
                <Col xl={8}>
                    ...
                    <p className="text-center lead mb-lg-5 mb-4">Property Management Software.</p>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td className="border-0">
                                    <Button href="https://example.com" target="_blank" variant="primary" className="m-0 mt-3 mb-3"><FontAwesomeIcon icon={faDownload} className="me-1" /> Download</Button>
                                </td>
                                <td className="border-0">
                                    <Button href="https://example.com/#/" target="_blank" variant="secondary" className="m-0 mt-3">Property Management Software<FontAwesomeIcon icon={faExternalLinkAlt} className="ms-1" /></Button>
                                </td>
                            </tr>
                        </tbody>
                    </Table>
